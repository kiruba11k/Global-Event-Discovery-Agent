...
<div class="body">
  ...
  <div class="disclaimer">
    ...
    on the official event website before registering. Meeting package pricing shown is indicative, quoted in
    USD plus local taxes as applicable, and based on the LeadStrategus internal pricing matrix v1
    ({deal_label} deal size category). Actual engagement fees may vary. Pipeline estimates assume a 40%
...
<!-- ══════════ FOOTER ══════════ -->
<div class="footer">
  <span>© {datetime.utcnow().year} <strong>LeadStrategus Private Limited</strong> · Event Intelligence · leadstrategus.com</span>
