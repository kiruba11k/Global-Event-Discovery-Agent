...
PERSONA_KEYWORDS: dict[str, list[str]] = {
    ...
    "marketing leader": ["CMO", "marketing director", "head of marketing", "demand gen", "VP marketing", "growth marketing"],
    "sales leader": ["VP sales", "head of sales", "chief revenue", "CRO", "sales director", "business development manager", "sales operations manager"],
    "product leader": ["CPO", "chief product officer", "VP product", "head of product", "product director"],
    "procurement leader": ["procurement head", "director of procurement", "sourcing director", "purchasing manager"],
    "it architect": ["enterprise architect", "solutions architect", "director of IT", "VP IT"],
