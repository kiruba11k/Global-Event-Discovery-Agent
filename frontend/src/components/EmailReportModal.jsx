...
export default function EmailReportModal({ isOpen, onClose, events, profile, dealSizeCategory }) {
              ...
              <>
                <div style={{ marginBottom:20 }}>
                  ...
                  <div style={{
                    ...
                    background:'var(--bg-input)', border:`1.5px solid ${errMsg ? 'var(--skip)' : 'var(--border)'}`,
                    borderRadius:'var(--radius-sm)', padding:'11px 14px',
                    transition:'border-color 0.2s, box-shadow 0.2s',
                  }}
                    onFocus={e => e.currentTarget.style.borderColor = 'var(--accent)'}
                    onBlur={e => e.currentTarget.style.borderColor = errMsg ? 'var(--skip)' : 'var(--border)'}
                  >
                  ...
                  {errMsg && (
                    <div style={{
                      ...
                      color:'var(--skip)', fontSize:11, marginTop:6,
                    }}>
                      <AlertCircle size={12} />
                      {errMsg}
                    </div>
                ...
                <div style={{
                  ...
                  {[
                    ...
                    'Meeting package pricing (LeadStrategus)',
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize:14, fontWeight:700, cursor: status === 'sending' || !email ? 'not-allowed' : 'pointer',
                    transition:'all 0.2s', boxShadow: status === 'sending' ? 'none' : '0 4px 16px rgba(6,182,212,0.3)',
                  }}
                >
                  {status === 'sending'
