...
const SECTIONS = [
  ...
  },
  {
    ...
    list: [
      ...
      'Use event contact or attendee information obtained through the Service , or any contact introduced to you through our meeting setting services, to send unsolicited bulk communications in violation of applicable anti spam law.',
  ...
  },
  {
    ...
    paragraphs: [
      'Prices shown for the Starter Pack, Growth Pack, and Full Takeover packages are indicative starting prices and are not a binding offer.Meeting numbers shown for the Starter Pack and Growth Pack are best-effort targets, not guarantees; only the Full Takeover package includes a contractual outcomes guarantee, as set out in its written agreement. Any meeting or outcomes figure generated by the Service is a directional, machine-generated proposal based on the inputs you provide. Your final guarantee is scoped to your unique selling proposition (USP), ideal customer profile (ICP), and customer references, and is confirmed only after a discussion with our team. A binding quote, scope of work, and payment terms are provided separately once you contact us and confirm your requirements.',
